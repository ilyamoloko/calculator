Проделал работу над следующим ТЗ 

РАЗРАБОТАТЬ КОНСОЛЬНЫЙ КАЛЬКУЛЯТОР С следующими требованиями :
...
Калькулятор разработан и соответствует требованиями.

Проделанная работа в коде :

* Создал тесты наших римских и арабских примеров.
* Создал интерфейс калькулятора.
* Создал класс MAIN.
* Добавил классы арабских чисел и римских.
* Создал класс конвертер .
* Конвертировал римские числа в арабские.
* Конвертировал строку.
